...
func queryNameStringIndicesCount(ctx context.Context, p *PopulatorImpl, sourceID int) (int, error) {
...
// for a given data source.
func queryVernacularIndicesCount(ctx context.Context, p *PopulatorImpl, sourceID int) (int, error) {
...
func deleteDataSource(ctx context.Context, p *PopulatorImpl, sourceID int) error {
...
func insertDataSource(ctx context.Context, p *PopulatorImpl, ds schema.DataSource) error {
	query := `
