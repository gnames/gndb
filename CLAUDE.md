...
- `main` branch is gong through ground up refactoring
- `spec-kit` branch contains original code generated by Claude using Spec-kit.
  and its code is coing to be transferred to main branch step by step.
